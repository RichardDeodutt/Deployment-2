...
main(){
    ...
    unzip awscliv2.zip && logokay "Successfully unzipped the AWS CLI" || { logerror "Failure unzipping the AWS CLI" && exiterror ; }
...
#Log successs
logokay "Successfully ran install AWS CLI script"
